  ...
  (e = function (t, e) {
    ...
    function M(t) {
      ...
      M.t ||
        Object.defineProperties(M, {
          ...
          M: {
            value(t, e) {
              ...
              return (
                U ||
                  (e
                    ? (U = WebAssembly.compile(M.o(e)))
                    : ((e = t.u),
                      (U = M.T(e).then((t) => WebAssembly.compile(t)))),
                  M.t.set(t, U)),
                U
              );
            },
          ...
          O: {
            value(t, e) {
              let i = new U(e),
                M = 0,
                r = 0;
              for (; M < t.length; ) i.set(t[M], r), (r += t[M++].length);
              return i;
            },
          },
          v: {
          ...
          J: {
            value(t, e, U, i) {
              ...
              for (r = 0; r < e; r++) {
                const e = [];
                for (s = 0; s < t.length; ) e.push(t[s++][r]);
                n.push(M.O(e, U));
              }
              return M.v(n, U, i);
            },
          ...
          o: {
            value(t) {
              const U = new e(t.length),
                i = parseInt(t.substring(11, 13), 16),
                M = 256 - i;
              let r,
                s = !1,
                n = 0,
        ...
        Object.defineProperty(this, "u", { $: !0, get: () => this.p }),
        (this.A = (t, e, U) => {
          let i = [],
            M = 0;
          for (; M < e; ) i.push(t.slice(M * U, M++ * U + U));
          return i;
        }),
        (this.L = (t, e) => {
          const U = this.p.R(e.BYTES_PER_ELEMENT * t);
          return this.F.add(U), { W: U, q: t, D: new e(this.p.N, U, t) };
        }),
        (this.free = () => {
          this.F.forEach((t) => {
            this.p.Z(t);
        ...
        (this.instantiate = () => {
          ...
          return (
            i && M.U(r, i),
            (this.p = new r(M).instantiate()),
            (this.F = new Set()),
            this.p.ready.then(
              () => ((t.I = this.L(s, e)), (t.X = this.L(n * o, U)), this)
            )
          );
        });
    }
    class r extends i.default {
        ...
        if (!r) {
          const e = `'use strict';(${
              ...
              ((t, e, U, i) => {
                ...
                self.onmessage = ({ data: { id: n, command: o, data: h } }) => {
                  let u,
                    a = s,
                    d = { id: n };
                  "module" === o
                    ...
                    : (Object.assign(
                        ...
                        M[o](
                          Array.isArray(h)
                            ? h.map((t) => new Uint8Array(t))
                            : new Uint8Array(h)
                        )
                      ),
                      (u = d.channelData.map((t) => t.buffer))),
                    a.then(() => self.postMessage(d, u));
                };
              })
            })(${JSON.stringify(t)}, ${U}, ${M}, ${i})`,
            s = "text/javascript";
          try {
            (r = URL.createObjectURL(new Blob([e], { type: s }))),
              M.t.set(U, r);
          } catch {
            r = `data:${s};base64,${Buffer.from(e).toString("base64")}`;
          }
        }
        super(r, { name: e }),
          (this.H = Number.MIN_SAFE_INTEGER),
          (this.tt = new Map()),
          (this.onmessage = ({ data: t }) => {
            const { id: e, ...U } = t;
            this.tt.get(e)(U), this.tt.delete(e);
          }),
          new i(M).M().then((t) => {
            this.et("module", t);
          });
      ...
      async et(t, e) {
        return new Promise((U) => {
          this.postMessage({ command: t, id: this.H, data: e }),
            this.tt.set(this.H++, U);
        });
      }
      get ready() {
        return this.et("ready");
      }
      async free() {
        await this.et("free").finally(() => {
          this.terminate();
        });
      }
      async reset() {
    ...
    function s(t) {
      ...
      for (var r = new Uint8Array(123), n = 25; n >= 0; --n)
        (r[48 + n] = 52 + n), (r[65 + n] = n), (r[97 + n] = 26 + n);
      (r[43] = 62),
        (r[47] = 63),
        s.u ||
          Object.defineProperty(s, "u", {
            get: () => String.raw`dynEncode0093¿ ÄUÃ8åbózæÁ®¦þõ#Ê4»K7ÝY¦ROW4=}ëTxÌVH6ö8=}8±ÚD½fTa±ÿUé±)ãüþ­.Ê@k_±þýYþ*âGù×I8jL¡/@FL1KX®ÉÑ/Ï= ª³»©þÃqpNuã&Á Á&óTp°)ó«Éô£³ºB¸k®ò[Ó©µ7¼%qQ"ÉSûãÝû´(>ÞY´¡æ{+Ä*Øã÷ÇÒ¶YÔ!ýÃ¿*õºvQn ¢¥£¹TïvÒ ¦&µïIì»K±:Î´L@k2ë©ëÔ(è×?4_Íñ[ñ\¹q[©¤Á¦þz
...
ÜÍOVª¹JvG.VÛèìa Qÿ	ÊPtÛ¶¼ÅÐÞwÿ|"Üá	raWâÐçjT?2O³TáÙ?D6þé²EÙ0©CòèZI ÿn­Ezÿ®æyOøba	= Lyÿn. Ib?tKÕ ´¸®@Ø ,p{Ô Mö^p¶>föYZç8~÷!AÕ"\ ÎðÜÛ	Bù$ çûcôS¾ÿCVºïVÂ¶³Õ¶»õ¶·åÛÖ×é-×	-4Ó°¿CUÎ¯óïG®µ! ¹ÇÖ½!ÖÕ1ÿW÷éçàÊ¿iÊ¶ÿ	fxÓÃ§!×ö×Å(a÷².2V;5þÕ[48= XYÿxyæUÉYXØWæë÷·&g<z)ÄÆú/O>Ø+é¤ch_JEí¬æî÷®×!ÎS¿÷îCZô¹×rRBx:àýÜp|^ß	@!Eç ñïlVÂ¶³Õ¶»õ£¥Ú	·$Õ­¬÷$Ö±Ñ12k$Ó4¢yÂ3{ªóXRQr-ò&M.é+9¥I*÷ï¼¼üu¢¬öÅÞpZGjpIe÷ê©* `,
      ...
      var o,
        ...
        O = {
          ...
          Mt(t, i) {
            ...
            0 === i || 10 === i
              ? ((1 === t ? e : U)(
                  ((t, e, U) => {
                    for (var i = 0; t[i] && !(i >= NaN); ) ++i;
                    return T.decode(
                      t.subarray
                        ? t.subarray(0, i)
                        : new Uint8Array(t.slice(0, i))
                    );
                  })(M)
                ),
                (M.length = 0))
          ...
          rt: void 0,
          get: () => ((O.rt += 4), o[(O.rt - 4) >> 2]),
          st(t) {
            var e = ((t, e) => {
              if (!t) return "";
              for (var U = t + void 0, i = t; !(i >= U) && h[i]; ) ++i;
              return T.decode(h.subarray(t, i));
            })(t);
            return e;
          },
          nt: (t, e) => t,
        ...
        v = {
          a() {
            U("missing function: INT123_compat_close"), M(-1);
          },
          f(t, e, U) {
            h.copyWithin(t, e, e + U);
          },
          e(t) {
            h.length, M("OOM");
          },
          ...
          g(t, e, U, i, M) {},
          c(t, e, U, i) {
            for (var M = 0, r = 0; r < U; r++) {
              var s = o[e >> 2],
                n = o[(e + 4) >> 2];
              e += 8;
              for (var u = 0; u < n; u++) O.Mt(t, h[s + u]);
              M += n;
            }
            return (o[i >> 2] = M), 0;
          },
      ...
      (this.U = (e) => {
        ...
        (this.instantiate = () => (
          this.M()
            .then((t) => WebAssembly.instantiate(t, J))
            .then((t) => {
              var e,
                U = t.exports;
              (a = U.j),
    ...
    function n(t = {}) {
      return (
        (this.ct = () =>
          new this.ft(this).instantiate().then((t) => {
            (this.lt = t),
              (this.Tt = 0),
              (this.Ot = this.lt.L(1, Uint32Array)),
              (this.vt = this.lt.L(1, Uint32Array)),
              (this.Jt = this.lt.u.ut());
          })),
        Object.defineProperty(this, "ready", { $: !0, get: () => this.$t }),
        (this.reset = () => (this.free(), this.ct())),
        (this.free = () => {
          this.lt.u.dt(this.Jt), this.lt.u.Z(this.Jt), this.lt.free();
        }),
        (this.wt = (t, e) => {
          if (!(t instanceof Uint8Array))
            throw Error(
              "Data to decode must be Uint8Array. Instead got " + typeof t
            );
          this.I.D.set(t), (this.Ot.D[0] = 0);
          const U = this.lt.u.at(
            this.Jt,
            this.I.W,
            t.length,
            this.Ot.W,
          ...
          return (
            (this.Tt = this.vt.D[0]),
            this.ft.v(
              [this.X.D.slice(0, U), this.X.D.slice(this._, this._ + U)],
              U,
              this.Tt
            )
          );
        ...
        (this.decode = (t) => {
          let e = [],
            U = 0,
            i = 0;
          for (; i < t.length; i += this.Ot.D[0]) {
            const M = this.wt(t.subarray(i, i + this.I.q), 48);
            e.push(M.channelData), (U += M.samplesDecoded);
          }
          return this.ft.J(e, 2, U, this.Tt);
        }),
        (this.decodeFrame = (t) => this.wt(t, t.length)),
        (this.decodeFrames = (t) => {
          let e = [],
            U = 0,
            i = 0;
          for (; i < t.length; ) {
            const M = this.decodeFrame(t[i++]);
            e.push(M.channelData), (U += M.samplesDecoded);
          }
          return this.ft.J(e, 2, U, this.Tt);
        }),
    ...
    (t.MPEGDecoder = n),
      (t.MPEGDecoderWebWorker = class extends r {
        constructor(t) {
          super(t, "mpg123-decoder", n, s);
        }
        async decode(t) {
          return this.et("decode", t);
        }
        async decodeFrame(t) {
          return this.et("decodeFrame", t);
        }
        async decodeFrames(t) {
          return this.et("decodeFrames", t);
        }
      }),
      Object.defineProperty(t, "yt", { value: !0 });
  }),
  "object" == typeof exports && "undefined" != typeof module
    ? e(exports, require("web-worker"))
    : "function" == typeof define && define.amd
    ? define(["exports", "web-worker"], e)
    : e(
